...
export const Dashboard = () => {
  ...
  return (
    <div className="h-[100vh] bg-slate-50 relative flex flex-col justify-between overflow-y-scroll">
      ...
      <div>
        ...
        <div className="p-3">
          <h1 className="mt-6 ml-4 text-3xl font-medium font-sans">
            All Boards
          </h1>
          <div className="mt-6 flex flex-wrap justify-evenly lg:justify-start">
            {drawings.length != 0 ? (
              ...
              <div className="w-full flex flex-col justify-center items-center">
                ...
                <div className="h-fit">
                  <CreateModal label={"New Whiteboard"}></CreateModal>
                </div>
              </div>
            )}
          </div>
