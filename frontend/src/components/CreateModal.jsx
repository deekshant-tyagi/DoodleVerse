...
export default function CreateModal({ label }) {
  ...
  return (
    <>
      {label ? (
        <button
          className="block px-4 py-2 bg-blue-500 hover:bg-blue-700 rounded text-lg font-semibold text-white"
          type="button"
          onClick={() => {
            setShowModal(true);
          }}
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl min-w-80">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  <h3 className="text-3xl font-semibold">New WhiteBoard</h3>
                  <button
                    className="p-1 ml-auto bg-transparent border-0 text-black hover:text-red-500 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                  ...
                  <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder="Write Drawing description here"
                      ></textarea>
                    </div>
                  </div>
                </div>
